...
[`clean_data()`](https://pandionlabs.github.io/jovanovic2025/reference/clean_data.md)
organizes `MasterThesisData2024` to be ready for analysis. An important
step is to aggregate columns into microhabitat categories.
...
The
[`get_model_cols()`](https://pandionlabs.github.io/jovanovic2025/reference/get_model_cols.md)
function creates a tibble that specifies each predictor variable and the
model family used in each model
...
The models can be produced with
[`create_models()`](https://pandionlabs.github.io/jovanovic2025/reference/create_models.md)
which will create each of the models specified in
[`get_model_cols()`](https://pandionlabs.github.io/jovanovic2025/reference/get_model_cols.md)
and then save the model summary, residuals, and results from three tests
of outliers, dispersion, and zero inflation. All these model results are
