...
`MasterThesisData2024` gives easy access to the table stored in `data-raw/MasterThesisData2024.csv`. `clean_data()` organizes `MasterThesisData2024` to be ready for analysis.
